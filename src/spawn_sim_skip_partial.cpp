    ...
    for (; row_index + 2 < hot_row_end; row_index += 2) {
        ...
        if (use_aligned_main_hot_loop) {
            ...
            for (; word_index < aligned_simd_word_end; word_index += sve_words) {
                ...
                incoming_partial0_b0 = svdup_u64(1); incoming_partial0_b1 = svdup_u64(0); incoming_partial0_b2 = svdup_u64(0); // SKIP_PARTIAL
                load_horizontal_partial_pair2_u64_sve(
                    pg,
                ...
                incoming_partial1_b0 = svdup_u64(1); incoming_partial1_b1 = svdup_u64(0); incoming_partial1_b2 = svdup_u64(0); // SKIP_PARTIAL
        ...
        if (use_aligned_main_hot_loop) {
            ...
            for (; word_index < aligned_simd_word_end; word_index += sve_words) {
                ...
                load_horizontal_partial_pair2_u64_sve(
                    ...
                    outgoing_partial_b1,
                    outgoing_partial_b2);
                incoming_partial_b0 = svdup_u64(1); incoming_partial_b1 = svdup_u64(0); incoming_partial_b2 = svdup_u64(0); // SKIP_PARTIAL
