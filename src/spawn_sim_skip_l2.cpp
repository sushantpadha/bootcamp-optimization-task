...
{
    // SKIP_L2: discard store to L2 partial cache
    (void)pg; (void)pair;
    (void)partial_b0; (void)partial_b1; (void)partial_b2;
}
...
inline void load_horizontal_partial_pair2_u64_sve(
    ...
    svuint64_t& partial_b2)
{
    // SKIP_L2: return zeros instead of L2-cached partial data
    (void)pg; (void)pair;
    partial_b0 = svdup_u64(0);
    partial_b1 = svdup_u64(0);
    partial_b2 = svdup_u64(0);
}
