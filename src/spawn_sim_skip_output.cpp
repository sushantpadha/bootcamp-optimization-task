...
{
    // SKIP_OUTPUT_COMPUTE: zero body — DRAM arg reads still happen, output logic removed
    (void)total_b0; (void)total_b1; (void)total_b2; (void)total_b3; (void)total_b4;
    (void)adult_word; (void)juvenile_word; (void)egg_word; (void)pg;
    next_adult_word = svdup_u64(0);
    next_egg_word   = svdup_u64(0);
}
